...
export default function Project({ project }) {
    ...
    return (
        <>
            <Head>
                <title>Harsh Muriki - {project.title} | harshmuriki.com</title>
                <meta
                    name='viewport'
                ...
                <meta
                    name='description'
                    content={"Harsh Muriki' " + project.title + '. ' + project.subtitle}
                />
                <meta
                    property='og:description'
                    content={"Harsh Muriki' " + project.title + '. ' + project.subtitle}
                />
                <meta property='og:title' content='Harsh Muriki' key='title' />
                <meta
                    property='og:image'
                ...
                <meta
                    property='og:url'
                    content={'https://harshmuriki.com/projects' + asPath}
                />
                <link
                    rel='canonical'
                    href={'https://harshmuriki.com/projects' + asPath}
                />
                <meta name='twitter:card' content='summary_large_image'></meta>
                <meta name='twitter:site' content='@harshmuriki24' />
                <meta name='twitter:creator' content='@harshmuriki42' />
                <meta name='twitter:title' content={`Harsh Muriki - ${project.title} | harshmuriki.com`} />
                <meta
